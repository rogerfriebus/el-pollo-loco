class AudioManager {
    ...
    resumeBackgroundIfNeeded() {
        ...
        this.backgroundInterval = setInterval(() => this.playBackgroundStep(), 1400);
    }
     ...
     */
    canRunBackground() {
        return !this.isMuted && this.isActivated && !this.backgroundInterval && this.backgroundShouldRun;
    }
     ...
     */
    canPlaySound() {
        return !this.isMuted && this.isActivated && this.audioContext?.state === "running";
    }
